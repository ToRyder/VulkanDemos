...
private:
    ...
    void CreatePipelines()
    {
        ...
        shaderStages[0].module = vk_demo::LoadSPIPVShader(m_Device, "assets/shaders/09_LoadMesh/mesh.vert.spv");
        shaderStages[0].pName  = "main";
        shaderStages[1].stage  = VK_SHADER_STAGE_FRAGMENT_BIT;
        shaderStages[1].module = vk_demo::LoadSPIPVShader(m_Device, "assets/shaders/09_LoadMesh/mesh.frag.spv");
